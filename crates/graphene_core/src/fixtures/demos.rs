...
use crate::{EdgeData, NodeId, Size2, Vec2};
...
pub fn add_cytoscape_demos<S: Copy + Default>(fixtures: &mut Vec<GraphFixture<S>>) {
    // 1. COMPOUND NODES DEMO
    {
        ...
        let b = f.state.add_node(Vec2::new(250.0, 85.0), Size2::new(180.0, 100.0));
        let a = f.state.add_node(Vec2::new(215.0, 85.0), Size2::new(40.0, 40.0));
        let c = f.state.add_node(Vec2::new(300.0, 85.0), Size2::new(40.0, 40.0));

        let d = f.state.add_node(Vec2::new(215.0, 175.0), Size2::new(40.0, 40.0));

        let e = f.state.add_node(Vec2::new(300.0, 175.0), Size2::new(80.0, 80.0));
        let fl = f.state.add_node(Vec2::new(300.0, 175.0), Size2::new(40.0, 40.0));
    ...
    // 2. ARCHITECTURE DEMO
    {
        ...
        let cy = f.state.add_node(Vec2::new(0.0, 0.0), Size2::new(450.0, 350.0));
        let api = f.state.add_node(Vec2::new(-80.0, 0.0), Size2::new(200.0, 200.0));
        let ext = f.state.add_node(Vec2::new(180.0, 0.0), Size2::new(160.0, 300.0));
        let app = f.state.add_node(Vec2::new(0.0, 280.0), Size2::new(80.0, 50.0));
        ...
        // API Children
        let core = f.state.add_node(Vec2::new(-120.0, -40.0), Size2::new(60.0, 40.0));
        let eles = f.state.add_node(Vec2::new(-40.0, -40.0), Size2::new(60.0, 40.0));
        let style = f.state.add_node(Vec2::new(-120.0, 40.0), Size2::new(60.0, 40.0));
        let selector = f.state.add_node(Vec2::new(-40.0, 40.0), Size2::new(60.0, 40.0));
        ...
        // Ext Children
        let layout = f.state.add_node(Vec2::new(180.0, -60.0), Size2::new(70.0, 35.0));
        let renderer = f.state.add_node(Vec2::new(180.0, 20.0), Size2::new(70.0, 35.0));
        let algo = f.state.add_node(Vec2::new(180.0, 100.0), Size2::new(70.0, 35.0));
    ...
    // 3. ANIMATED BFS DEMO
    {
        ...
        let a = f.state.add_node(Vec2::new(0.0, -100.0), Size2::new(40.0, 40.0));
        let b = f.state.add_node(Vec2::new(100.0, -40.0), Size2::new(40.0, 40.0));
        let c = f.state.add_node(Vec2::new(80.0, 80.0), Size2::new(40.0, 40.0));
        let d = f.state.add_node(Vec2::new(-80.0, 80.0), Size2::new(40.0, 40.0));
        let e = f.state.add_node(Vec2::new(-100.0, -40.0), Size2::new(40.0, 40.0));
    ...
    // 4. EDGE ROUTING TYPES DEMO
    {
        ...
        let s1 = f.state.add_node(Vec2::new(-150.0, -100.0), Size2::new(40.0, 30.0));
        let t1 = f.state.add_node(Vec2::new(150.0, -100.0), Size2::new(40.0, 30.0));
        ...
        let s2 = f.state.add_node(Vec2::new(-150.0, 0.0), Size2::new(40.0, 30.0));
        let t2 = f.state.add_node(Vec2::new(150.0, 0.0), Size2::new(40.0, 30.0));
        ...
        let s3 = f.state.add_node(Vec2::new(-150.0, 100.0), Size2::new(40.0, 30.0));
        let t3 = f.state.add_node(Vec2::new(150.0, 100.0), Size2::new(40.0, 30.0));
    ...
    // 5. WINE & CHEESE PAIRING DEMO (Bipartite)
    {
        ...
        let pairings = vec![
            (0, 0), (0, 4), // Chardonnay -> Brie, Camembert
            (1, 0), (1, 2), // Pinot Noir -> Brie, Gouda
            (2, 1), (2, 3), // Cabernet -> Cheddar, Blue Cheese
            (3, 2), (3, 4), // Riesling -> Gouda, Camembert
        ];

        for (w_idx, c_idx) in pairings {
            f.state.add_edge(wine_ids[w_idx], cheese_ids[c_idx], EdgeData::default());
        }
    ...
    // 6. TOKYO RAILWAYS TOPOLOGY DEMO
    {
        ...
        for i in 0..n {
            f.state.add_edge(station_ids[i], station_ids[(i + 1) % n], EdgeData::default());
        }

        // Chuo Line shortcut (Tokyo <-> Shinjuku)
        f.state.add_edge(station_ids[0], station_ids[4], EdgeData::default());
    ...
    // 7. GENE NETWORK DEMO (fCoSE)
    {
        ...
        let cell = f.state.add_node(Vec2::new(0.0, 0.0), Size2::new(300.0, 220.0));
        let nucleus = f.state.add_node(Vec2::new(-40.0, 0.0), Size2::new(140.0, 120.0));
        ...
        let g1 = f.state.add_node(Vec2::new(-70.0, -20.0), Size2::new(30.0, 25.0));
        let g2 = f.state.add_node(Vec2::new(-10.0, 20.0), Size2::new(30.0, 25.0));
        ...
        let r1 = f.state.add_node(Vec2::new(80.0, -50.0), Size2::new(30.0, 25.0));
        let r2 = f.state.add_node(Vec2::new(80.0, 40.0), Size2::new(30.0, 25.0));
    ...
    // 8. HIGH-ELEMENT PERFORMANCE DEMO (1000 nodes, 1500 edges)
    {
        ...
        for i in 0..count {
            let r = i / side;
            let c = i % side;
            let pos = Vec2::new((c as f32 - side as f32 / 2.0) * 40.0, (r as f32 - side as f32 / 2.0) * 40.0);
        ...
        for i in 0..count {
            ...
            if c + 1 < side && i + 1 < count {
                f.state.add_edge(nodes[i], nodes[i + 1], EdgeData::default());
            }
            if r + 1 < side && i + side < count {
                f.state.add_edge(nodes[i], nodes[i + side], EdgeData::default());
            }
        }
