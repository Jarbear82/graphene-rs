...
pub fn add_basic_fixtures<S: Copy + Default>(fixtures: &mut Vec<GraphFixture<S>>) {
    ...
    // 5. COMPOUND & HYPERGRAPH
    {
        ...
        let p = f.state.add_node(Vec2::new(0.0, 0.0), Size2::new(120.0, 80.0));
        let c1 = f.state.add_node(Vec2::new(-30.0, 0.0), Size2::new(30.0, 30.0));
        let c2 = f.state.add_node(Vec2::new(30.0, 0.0), Size2::new(30.0, 30.0));
        ...
        let n1 = f.state.add_node(Vec2::new(-60.0, -40.0), Size2::new(30.0, 30.0));
        let n2 = f.state.add_node(Vec2::new(60.0, -40.0), Size2::new(30.0, 30.0));
        let n3 = f.state.add_node(Vec2::new(0.0, 40.0), Size2::new(30.0, 30.0));
